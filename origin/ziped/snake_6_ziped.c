...
int j;
int d;
if(r<0||r>=ROWS||c<0||c>=COLS||game->wallmap[r][c]){
return 0;
}
...
if((game->nval>=512&&game->stepcnt>4200)||(game->nval>=256&&elapsed>270)||(game->nval>=128&&elapsed>300)){
