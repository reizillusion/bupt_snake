...
if(!sim_follow_state(in_sr,in_sc,in_len,step0,food_tr,food_tc,pathr,pathc,plen,tmp_sr,tmp_sc,&tmp_slen,&lastdir)){
return 0;
}
if(lastdir<0){
return 0;
...
if(food_len>0){
food_safe=safe_after_path(nsr,nsc,nlen,stepcnt+1,foodr,foodc,pathr,pathc,food_len);
}
}
