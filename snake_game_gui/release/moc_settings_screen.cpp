/****************************************************************************
** Meta object code from reading C++ file 'settings_screen.h'
**
...
#error "The header file 'settings_screen.h' doesn't include <QObject>."
...
QT_MOC_LITERAL(3, 30, 12), // "GameSettings"
QT_MOC_LITERAL(4, 43, 8), // "settings"
QT_MOC_LITERAL(5, 52, 13) // "backRequested"

    },
    "SettingsScreen\0settingsSaved\0\0"
    "GameSettings\0settings\0backRequested"
};
...
void SettingsScreen::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->settingsSaved((*reinterpret_cast< const GameSettings(*)>(_a[1]))); break;
        ...
        {
            using _t = void (SettingsScreen::*)(const GameSettings & );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&SettingsScreen::settingsSaved)) {
                *result = 0;
                return;
            }
        }
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&SettingsScreen::backRequested)) {
                *result = 1;
                return;
            }
        }
...
// SIGNAL 0
void SettingsScreen::settingsSaved(const GameSettings & _t1)
{
...
// SIGNAL 1
void SettingsScreen::backRequested()
{
